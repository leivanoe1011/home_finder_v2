...
function createCard(index, property) {
    ...
    var propertyObj = {
        ...
        googleDirections: `http://maps.google.com/maps?q=${propertyObj.city}+${propertyObj.state}+${propertyObj.addressLine}`
    }
    ...
    displayCard(index, propertyObj.homeWebSite, propertyObj.addressLine, propertyObj.beds
        ...
        ,propertyObj.lotSize, propertyObj.lotUnit, propertyObj.houseSize, propertyObj.houseUnit, propertyObj.houseImage, propertyObj.googleDirections);
};
